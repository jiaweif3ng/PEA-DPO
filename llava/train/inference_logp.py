...
class DataArguments:
    ...
    data_dir: str = '/NAS/fengjw/.cache/base_datasets/RLAIF-V-Dataset_22k' # !!!
...
class PreferenceInferenceDataset(torch_data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return rej_data_dict, win_data_dict # win_data_dict{'inputs_ids', 'labels', 'images'}
...
def main():
    ...
    write_logp_to_preference_parquet(dataset.data, data_path_self, logps, overwrite_logps=False)
