...
deepspeed --master_port 25433 --include  localhost:0,1,4,5 \
    ...
    --bf16 True \
    --output_dir /NAS/fengjw/.cache/output/DAMA/main/llava7b_repo_reference_free_gamma_15_gamma_copo_45_copocoef_14 \
    --num_train_epochs 8 \
